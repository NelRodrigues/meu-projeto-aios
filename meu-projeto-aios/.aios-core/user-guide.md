...
📦 Select Expansion Packs to Install:
  ...
  ◯ content-distillery (YouTube livestream → frameworks + content)
...
└── Squads/               # ✅ Se expansion packs selecionados
    ...
    ├── content-distillery/        # YouTube livestream processing
    └── marketing-opes/            # Marketing operations squad
```
...
- **content-distillery** - Transforma livestreams do YouTube em frameworks estruturados e conteúdo multi-plataforma
