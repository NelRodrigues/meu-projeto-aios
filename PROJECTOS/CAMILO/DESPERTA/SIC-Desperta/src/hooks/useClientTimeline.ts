    ...
    queryFn: async () => {
      ...
      if (lead) {
        ...
        if (lead.created_at) {
          ...
          events.push({
            ...
            time: new Date(lead.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'lead',
            team: 'sales',
            title: 'Lead Criado',
            description: [
        ...
        if (lead.checkout_visited_at) {
          events.push({
            ...
            time: new Date(lead.checkout_visited_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'checkout',
            team: 'sales',
        ...
        if (lead.pix_generated_at) {
          events.push({
            ...
            time: new Date(lead.pix_generated_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'payment',
            team: 'sales',
            title: 'PIX Gerado',
            description: 'Cliente gerou PIX para pagamento.',
            details: `Valor: Kz ${parseFloat(lead.trans_value || 0) / 100}`
          });
        }
      }
      ...
      visitsByDay.forEach((dayVisits, day) => {
        ...
        events.push({
          ...
          time: new Date(firstVisit.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'visit',
          team: 'sales',
      ...
      externalTransactions.forEach((tx: any) => {
        ...
        events.push({
          ...
          details: `Kz ${amount.toLocaleString('pt-AO', { minimumFractionDigits: 2 })} • ${tx.payment_method === 'CREDIT_CARD' || tx.payment_method === 'credit_card' ? 'Cartão' : tx.payment_method === 'bank_slip' ? 'Boleto' : tx.payment_method} • ${tx.payment_platform}`,
          amount,
      ...
      (deals || []).forEach((deal: any) => {
        ...
        if (!isWebinarPipeline) {
          events.push({
            ...
            time: new Date(deal.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'checkout',
            team: 'sales',
            title: `💼 Nova Negociação: ${deal.product?.name || deal.title || 'Deal'}`,
            description: `Negociação iniciada no valor de Kz ${dealValue.toLocaleString('pt-AO')}.`,
        ...
        if (deal.won_at) {
          ...
          const detailParts = [`Valor: Kz ${dealValue.toLocaleString('pt-AO')}`];
          ...
          events.push({
            id: `deal-won-${deal.id}`,
            date: deal.won_at,
            time: new Date(deal.won_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'purchase',
            team: 'sales',
            title: `🎉 Deal Fechado: ${productName}`,
            description: `Fechado por ${repName} — Kz ${dealValue.toLocaleString('pt-AO')}`,
        ...
        if (deal.status === 'lost' && deal.lost_at) {
          ...
          if (!isChurnOrRefund) {
            ...
            events.push({
              ...
              date: deal.lost_at,
              time: new Date(deal.lost_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
              type: 'lead',
              team: 'sales',
        ...
        if (transfers && Array.isArray(transfers)) {
          transfers.forEach((transfer: any, idx: number) => {
            events.push({
              ...
              time: new Date(transfer.transferred_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
              type: 'lead' as const,
              team: 'sales',
      ...
      (webinarEnrollments || []).forEach((enr: any) => {
        ...
        events.push({
          ...
          time: new Date(enr.enrolled_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'registration',
          team: 'sales',
      ...
      (eventRegs || []).forEach((reg: any) => {
        ...
        if (reg.first_join_time) {
          const joinTime = new Date(reg.first_join_time).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' });
          detailsParts.push(`Entrou: ${joinTime}`);
        }
        if (reg.last_leave_time) {
          const leaveTime = new Date(reg.last_leave_time).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' });
        ...
        events.push({
          ...
          time: new Date(eventDate || reg.registration_date).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'registration',
          team: 'sales',
          title,
          description,
      ...
      // 4.5 Event RSVPs (eventos presenciais - cs_event_rsvps)
      {
        ...
        uniqueRsvps.forEach((rsvp: any) => {
          ...
          const eventDate = rsvp.event?.start_date
            ? new Date(rsvp.event.start_date).toLocaleDateString('pt-AO')
            : null;
          ...
          if (rsvp.rsvp_status === 'confirmed') {
            ...
            if (rsvp.checked_in_at) {
              const checkinTime = new Date(rsvp.checked_in_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' });
          ...
          events.push({
            ...
            time: new Date(rsvp.confirmed_at || rsvp.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'event_rsvp',
            team: 'sales',
          ...
          if (rsvp.checked_in_at) {
            events.push({
              ...
              time: new Date(rsvp.checked_in_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
              type: 'event_rsvp',
              team: 'sales',
      ...
      (npsResponses || []).forEach((nps: any) => {
        ...
        events.push({
          id: `nps-${nps.id}`,
          date: nps.created_at,
          time: new Date(nps.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
      ...
      (painRegs || []).forEach((reg: any) => {
        ...
        const amountPaid = reg.amount_paid ? `Kz ${(reg.amount_paid / 100).toLocaleString('pt-AO')}` : null;
        const amountTotal = reg.amount_total ? `Kz ${(reg.amount_total / 100).toLocaleString('pt-AO')}` : null;
        const amountBalance = reg.amount_balance ? `Kz ${(reg.amount_balance / 100).toLocaleString('pt-AO')}` : null;
        ...
        events.push({
          id: `pain-reg-${reg.id}`,
          date: reg.created_at,
          time: new Date(reg.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'registration',
          team: 'sales',
      ...
      if (latestDiagnostic) {
        ...
        events.push({
          ...
          time: new Date(diag.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'registration',
          team: 'sales',
      ...
      (alunos || []).forEach((aluno: any) => {
        if (aluno.onboarding_inicio) {
          events.push({
            ...
            time: new Date(aluno.onboarding_inicio).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'onboarding',
            team: 'cs',
        ...
        if (aluno.onboarding_conclusao) {
          events.push({
            ...
            time: new Date(aluno.onboarding_conclusao).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'onboarding',
            team: 'cs',
        ...
        (activities || []).forEach((activity: any) => {
          ...
          if (activity.task_type === 'webinar') {
            ...
            const eventDateStr = meta.event_date
              ? new Date(meta.event_date).toLocaleDateString('pt-AO', { day: '2-digit', month: '2-digit', year: 'numeric', timeZone: 'Africa/Luanda' })
              : null;
            events.push({
              id: `webinar-${activity.id}`,
              date: activity.created_at,
              time: new Date(activity.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              type: 'webinar',
              team: 'marketing',
          ...
          if (activity.task_type === 'churn') {
            ...
            if (meta.has_refund && meta.refund_amount) detailParts.push(`Reembolso: Kz ${Number(meta.refund_amount).toLocaleString('pt-AO')}`);
          ...
          if (activity.scheduled_at) {
            ...
            events.push({
              ...
              time: scheduledDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              ...
              description: activity.status === 'no_show'
                ...
                : activity.completed
                  ...
                  : `${typeLabel} agendada para ${scheduledDate.toLocaleDateString('pt-AO', { timeZone: 'Africa/Luanda' })} às ${scheduledDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' })}.`,
        ...
        (onboardings || []).forEach((onb: any) => {
          ...
          if (onb.created_at) {
            events.push({
              ...
              date: onb.created_at,
              time: new Date(onb.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              type: 'onboarding',
              team: 'cs',
          ...
          if (onb.form_sent_at) {
            events.push({
              ...
              time: new Date(onb.form_sent_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              type: 'onboarding',
              team: 'cs',
          ...
          if (onb.form_completed_at) {
            events.push({
              ...
              time: new Date(onb.form_completed_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              type: 'onboarding',
              team: 'cs',
          ...
          if (onb.approved_at) {
            ...
            events.push({
              ...
              time: new Date(onb.approved_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Luanda' }),
              type: 'onboarding',
              team: 'cs',
      ...
      lessonsByDay.forEach((dayLessons, day) => {
        ...
        events.push({
          ...
          time: new Date(firstLesson.last_watched_at || firstLesson.started_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'lesson',
          team: 'cs',
      ...
      messagesByDay.forEach((dayMessages, day) => {
        ...
        if (clientMessages.length > 0 || teamMessages.length > 0) {
          events.push({
            ...
            time: new Date(firstMsg.sent_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'whatsapp',
            team: 'cs',
      ...
      if (lead?.instagram_profile_id) {
        ...
        if (igProfile) {
          events.push({
            ...
            time: new Date(igProfile.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'instagram',
            team: 'sales',
          ...
          igMessagesByDay.forEach((dayMessages, day) => {
            ...
            if (clientMessages.length > 0 || teamMessages.length > 0) {
              ...
              events.push({
                ...
                time: new Date(firstMsg.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
                type: 'instagram',
                team: 'sales',
        ...
        (tasks || []).forEach((task: any) => {
          ...
          events.push({
            ...
            time: task.due_datetime 
              ? new Date(task.due_datetime).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' })
              : new Date(task.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
      ...
      if (organizationId) {
        ...
        (touchpoints || []).forEach((tp: any) => {
          ...
          if (tp.next_contact_date) {
            detailsParts.push(`📅 Próximo contato: ${new Date(tp.next_contact_date).toLocaleDateString('pt-AO')}`);
          }
          ...
          events.push({
            ...
            time: new Date(tp.created_at || tp.touchpoint_date).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            type: 'touchpoint',
            team: 'cs',
      ...
      (calls || []).forEach((call: any) => {
        ...
        events.push({
          ...
          time: new Date(call.started_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'call',
          team: 'sales',
          title,
          description,
      ...
      (meetings || []).forEach((meeting: any) => {
        ...
        events.push({
          ...
          time: new Date(meeting.started_at || meeting.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'meeting',
      ...
      (notes || []).forEach((note: any) => {
        ...
        events.push({
          ...
          time: new Date(note.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          type: 'note',
          team: 'sales',
        ...
        (palestras || []).forEach((p: any) => {
          ...
          if (pPhone === normalizedPhone) {
            ...
            events.push({
              id: `palestra-${p.id}`,
              date: p.created_at,
              time: new Date(p.created_at).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
              type: 'palestra',
              team: 'sales',
      ...
      if (resolvedOrgId) {
        ...
        testimonials?.forEach((t: any) => {
          ...
          events.push({
            id: `testimonial-${t.id}`,
            date,
            time: new Date(date).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
