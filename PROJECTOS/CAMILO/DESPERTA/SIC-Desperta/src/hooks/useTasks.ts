      ...
      if (['call', 'meeting'].includes(input.task_type)) {
        try {
          ...
          triggerNotificationEvent('meeting_scheduled', {
            ...
            meeting_data: meetDate ? meetDate.toLocaleDateString('pt-AO') : '-',
            meeting_hora: meetDate ? meetDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }) : '-',
      ...
      if (
        ...
        try {
          ...
          triggerNotificationEvent('meeting_rescheduled', {
            ...
            responsavel: repName || '-',
            meeting_data: newDate.toLocaleDateString('pt-AO'),
            meeting_hora: newDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
            meeting_tipo: task.task_type === 'call' ? 'Call' : 'Reunião',
            meeting_source: 'manual',
            meeting_data_anterior: oldDate.toLocaleDateString('pt-AO'),
            meeting_hora_anterior: oldDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' }),
          });
        } catch (notifErr) {
