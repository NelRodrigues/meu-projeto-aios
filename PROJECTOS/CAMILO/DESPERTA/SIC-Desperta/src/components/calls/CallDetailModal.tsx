...
export function CallDetailModal({ open, onOpenChange, call, hideLeadLink = false }: CallDetailModalProps) {
  ...
  const handleGeneratePDF = useCallback(async () => {
    ...
    try {
      ...
      const dateStr = startDate.toLocaleDateString('pt-AO', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' });
      const timeStr = startDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' })
        + (endDate ? ` - ${endDate.toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' })}` : '');
                                  ...
                                  <div className="flex items-center gap-2 mt-2 flex-wrap">
                                    ...
                                    {task.data_hora_especifica ? (
                                      <Badge variant="outline" className="text-[10px] h-5 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300">
                                        ...
                                        {new Date(task.data_hora_especifica).toLocaleString('pt-AO', {
                                          day: '2-digit',
                                          month: '2-digit',
                                          hour: '2-digit',
                                          minute: '2-digit'
