      ...
      <Card className="shadow-2xl bg-white dark:bg-slate-900 border-2 overflow-hidden">
                ...
                <div key={s.id} className={cn('p-1.5 rounded border text-xs', style.bg)}>
                  <div className="flex items-center justify-between mb-0.5">
                    ...
                    <span className="text-[9px] text-muted-foreground">
                      {new Date(s.timestamp).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' })}
                    </span>
                  </div>
                      ...
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          <span className="text-[10px] text-muted-foreground">
                            {new Date(suggestion.timestamp).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                          </span>
                        </div>
        ...
        <div className="px-3 py-2 bg-slate-50 dark:bg-slate-800 border-t flex items-center justify-between text-xs text-muted-foreground">
          <span className="flex items-center gap-1">
            ...
            {state.startedAt
              ? new Date(state.startedAt).toLocaleTimeString('pt-AO', { hour: '2-digit', minute: '2-digit' })
              : '--:--'}
          </span>
