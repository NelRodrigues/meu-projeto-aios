...
function addLuandaTimezone(datetime: string | undefined): string | undefined {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (meetingTypes.includes(taskType) && !isPastDate && meetingType === 'auto' && dateTime && assigneeId && canCreateMeet) {
        ...
        try {
          ...
          const calendarResult = await createCalendarEvent({
            ...
            startDateTime: addLuandaTimezone(dateTime) || dateTime,
      ...
      const createdTask = await createTask.mutateAsync({
        ...
        scheduled_at: dateTime ? addLuandaTimezone(dateTime) : undefined,
        due_datetime: dateTime ? addLuandaTimezone(dateTime) : undefined,
        ...
        try {
          ...
          await supabase.functions.invoke('send-meeting-email', {
            body: {
              ...
              meeting_date: addLuandaTimezone(dateTime) || dateTime,
