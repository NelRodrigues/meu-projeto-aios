...
export function QuickCreateTaskModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Monta datetime com timezone de Luanda (-03:00)
      ...
      if (isAllDay) {
        // Para dia inteiro, usa 09:00 do dia (horário comercial) com timezone Luanda
        ...
        // Com horário específico, usa timezone Luanda
