              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground mt-0.5 pl-5">
                  {block.block_type === "one_time" && block.start_datetime && block.end_datetime ? (
                    <>
                      {new Date(block.start_datetime).toLocaleString("pt-AO", { dateStyle: "short", timeStyle: "short" })}
                      {" → "}
                      {new Date(block.end_datetime).toLocaleString("pt-AO", { dateStyle: "short", timeStyle: "short" })}
                    </>
                  ) : (
                    <>
