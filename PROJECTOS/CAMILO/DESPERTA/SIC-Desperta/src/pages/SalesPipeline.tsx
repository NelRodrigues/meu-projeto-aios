...
export function PipelineBoardContent() {
  ...
  const activeAdvancedFilters = useMemo(() => {
    ...
    if (revenueFilter !== "all") filters.push({ key: "revenue", label: { "100k+": "+Kz100k", "50k-100k": "Kz50k-100k", "10k-50k": "Kz10k-50k", "ate10k": "Até Kz10k", "sem_faturamento": "Sem info" }[revenueFilter] || revenueFilter, onRemove: () => setRevenueFilter("all") });
