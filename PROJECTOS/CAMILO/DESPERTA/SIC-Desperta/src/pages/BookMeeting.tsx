                ...
                {bookingResult?.scheduled_at && (
                  <div className="bg-blue-50 rounded-xl p-4 space-y-2">
                    <div className="flex items-center justify-center gap-2 text-gray-700">
                      ...
                      <span className="font-semibold">{new Date(bookingResult.scheduled_at).toLocaleDateString("pt-AO", { weekday: "long", day: "numeric", month: "long", timeZone: "Africa/Luanda" })}</span>
                    </div>
                    <div className="flex items-center justify-center gap-2 text-gray-700">
                      <Clock className="w-4 h-4 text-blue-500" />
                      <span className="font-semibold text-lg">{new Date(bookingResult.scheduled_at).toLocaleTimeString("pt-AO", { hour: "2-digit", minute: "2-digit", timeZone: "Africa/Luanda" })}</span>
                    </div>
                  </div>
                )}
