...
const PERSONAS: Record<string, {
  ...
  roberto_cetico: {
    ...
    company: "TechNova",
    avatar: "RM",
    profile: `Pragmático, direto, não gosta de papo furado. Já foi enganado por consultorias antes. Quer ver DADOS e CASES concretos. Desconfia de promessas. Fala pouco, escuta com cara de "me convença". Quando não concorda, fica em silêncio ou faz "hm, tá". Tem 45 funcionários e fatura Kz8M/ano.`,
    objections: [
    ...
    hiddenInfo: {
      funcionarios: "45",
      faturamento: "Kz8M/ano",
      tentativa_anterior: "Consultoria de processos em 2024, gastou Kz60k sem resultado",
      budget: "Até Kz15k/mês se convencer",
      decisor: "Ele + CFO (Ana)",
  ...
  ana_preco: {
    ...
    hiddenInfo: {
      funcionarios: "120",
      faturamento: "Kz25M/ano",
      tentativa_anterior: "Usa ferramentas internas, mas são limitadas",
      budget: "Kz8k-12k/mês aprovado, acima precisa de board",
      decisor: "Ela aprova até Kz12k, acima vai pro board",
  ...
  carlos_tecnico: {
    ...
    hiddenInfo: {
      ...
      faturamento: "Kz15M/ano",
      tentativa_anterior: "Avaliou 3 soluções, nenhuma teve integração boa",
      budget: "Kz20k/mês se resolver o problema técnico",
  ...
  pedro_apressado: {
    ...
    hiddenInfo: {
      funcionarios: "30",
      faturamento: "Kz5M/ano, crescendo 40% ao ano",
      tentativa_anterior: "Faz tudo na raça, nunca terceirizou",
      budget: "Paga na hora se fizer sentido, até Kz10k/mês",
