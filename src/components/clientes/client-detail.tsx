...
// Estágios válidos do lead (backend dedicado single-tenant da GM, ADR-01).
const ESTAGIOS: ClienteEstagio[] = ['novo', 'contactado', 'orcamento', 'activo', 'vip', 'inactivo']
...
export function ClientDetail({ cliente: initialCliente, mensagensRecentes }: ClientDetailProps) {
  ...
  // Tabela nuclear de contactos = `leads` (era `clientes` na base ISILDA).
  const tabela = 'leads'
  ...
  return (
    <div className="space-y-6 p-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Coluna Direita — Ficha 360º, Inteligência IA e Financeiro chegam nos Épicos 2/3 */}
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border border-dashed border-gray-200 p-8 text-center text-sm text-gray-400">
            Ficha 360º, inteligência do lead e financeiro — Épicos 2 e 3.
          </div>
        </div>
      </div>
    </div>
