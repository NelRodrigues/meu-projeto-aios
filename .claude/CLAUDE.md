...
**Linguagem Padrão:** Português de Angola (pt-AO)

⚠️ **IMPORTANTE:** Responda SEMPRE em português de Angola. Não use português de Portugal ou português brasileiro.
- Use vocabulário angolano
- Use expressões naturais de Angola
- Use o dialeto e as variações linguísticas de Angola
- Todos os exemplos, documentação e conteúdo devem estar em português de Angola

**Exemplos de linguagem:**
- "Deixa-me" em vez de "Deixe-me" (Portugal) ou "Me deixa" (Brasil)
- "Bué" em vez de "Muito" (uso informal angolano)
- "Ficheiro" em vez de "Arquivo" (Brasil)
- "Ecrã" em vez de "Tela" (Brasil)
- "Fixe" / "Na boa" em vez de "Legal" (Brasil) ou "Giro" (Portugal)
